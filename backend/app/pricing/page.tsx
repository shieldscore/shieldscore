...
export const metadata: Metadata = {
  ...
  description:
    "Simple, transparent pricing for Stripe account health monitoring. Monitor plan at $29/mo, Defend plan at $59/mo.",
};

function CheckIcon({ disabled = false }: { disabled?: boolean }) {
  return (
    <svg
      className={`h-[18px] w-[18px] shrink-0 ${disabled ? "text-[#e5e7eb]" : "text-[#22c55e]"}`}
      viewBox="0 0 24 24"
      fill="none"
      stroke="currentColor"
      strokeWidth="2.5"
      ...
      <section className="px-6 pt-[140px] pb-[100px]">
        <div className="mx-auto max-w-[1100px]">
          ...
          <p className="mx-auto mb-14 max-w-[480px] text-center text-[17px] leading-[1.7] text-[#555555]">
            Both plans use read-only access. We never touch your funds. Cancel
            anytime.
          </p>

          <div className="mx-auto grid max-w-[720px] gap-5 md:grid-cols-2">
            {/* Monitor */}
            <div className="rounded-[14px] border border-[#e5e7eb] p-9">
              ...
              <ul className="mb-7 list-none space-y-0">
                ...
                {["Slack & SMS alerts", "Velocity anomaly detection"].map((f) => (
                  <li
                    key={f}
                    className="flex items-center gap-2.5 border-b border-[#e5e7eb] py-2.5 text-[15px] text-[#888888]"
                  >
                    <CheckIcon disabled />
                    {f}
                  </li>
              ...
              <PricingButton plan="monitor" variant="outline">
                Start monitoring
              </PricingButton>
            </div>

            {/* Defend */}
            <div className="relative rounded-[14px] border-2 border-[#111111] p-9">
              ...
              <div className="mb-1 text-[48px] font-bold">
                $59<span className="text-base font-normal text-[#888888]">/mo</span>
              </div>
              <div className="mb-7 text-sm text-[#888888]">
              ...
              <PricingButton plan="defend" variant="filled">
                Start defending
              </PricingButton>
            </div>
          </div>
